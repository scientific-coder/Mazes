...
if((i < len)){
var k = (ks[i]);
var G__17785 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__17786 = (i + (1));
m = G__17785;
i = G__17786;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__17790 = c;
var G__17790__$1 = (((G__17790 == null))?null:G__17790.prototype);
if((G__17790__$1 == null)){
return null;
} else {
return (G__17790__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__17794 = c;
var G__17794__$1 = (((G__17794 == null))?null:G__17794.prototype);
if((G__17794__$1 == null)){
return null;
} else {
return (G__17794__$1["render"]);
}
})()));
});
...
var G__17798 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__17798) : reagent.impl.component.as_element.call(null,G__17798));
};
...
var _STAR_current_component_STAR_17805 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_17805;
}});
...
var G__17813 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__17813) {
...
return ((function (G__17813){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__17816 = reagent.impl.component.state_atom(c);
var G__17817 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__17816,G__17817) : cljs.core.reset_BANG_.call(null,G__17816,G__17817));
});
;})(G__17813))
...
var or__7389__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__17819_17821 = (c["cljsRatom"]);
if((G__17819_17821 == null)){
} else {
reagent.ratom.dispose_BANG_(G__17819_17821);
}
...
if(cljs.core.truth_((function (){var and__7377__auto__ = wrap;
...
var renders_17824 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_17825 = cljs.core.first(cljs.core.vals(renders_17824));
if((cljs.core.count(renders_17824) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_17824))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_17825)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_17825], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__7389__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__7389__auto__)){
return or__7389__auto__;
} else {
...
var render_fun__$1 = (function (){var or__7389__auto__ = render_fun;
if(cljs.core.truth_(or__7389__auto__)){
return or__7389__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__7389__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__7389__auto__)){
return or__7389__auto__;
} else {
...
var name__$1 = (function (){var G__17823 = name;
switch (G__17823) {
case "":
...
var elem = (function (){var G__17834 = (function (){var or__7389__auto__ = (function (){var G__17836 = c;
if((G__17836 == null)){
return null;
} else {
return (G__17836["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__7389__auto__)){
return or__7389__auto__;
...
return (G__17834["_currentElement"]);
}
})();
var name = (function (){var G__17837 = elem;
var G__17837__$1 = (((G__17837 == null))?null:(G__17837["type"]));
if((G__17837__$1 == null)){
return null;
} else {
return (G__17837__$1["displayName"]);
}
})();
var path = (function (){var G__17838 = elem;
var G__17838__$1 = (((G__17838 == null))?null:(G__17838["_owner"]));
var G__17838__$2 = (((G__17838__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__17838__$1) : reagent.impl.component.component_path.call(null,G__17838__$1)));
if((G__17838__$2 == null)){
return null;
} else {
return [cljs.core.str(G__17838__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__7389__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__7389__auto__)){
return or__7389__auto__;
} else {
var G__17840 = c;
var G__17840__$1 = (((G__17840 == null))?null:G__17840.constructor);
if((G__17840__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__17840__$1);
}
}
})();
