...
return cljs.core._write.call(null,writer__8042__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__12660 = o;
(G__12660[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__7377__auto__ = cljs.core.some_QMARK_.call(null,jsprops);
...
var G__12669 = jsprops;
(G__12669["defaultValue"] = value);

(G__12669["onChange"] = ((function (G__12669,v,value,on_change){
return (function (p1__12666_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__12666_SHARP_);
});})(G__12669,v,value,on_change))
);

(G__12669["ref"] = ((function (G__12669,v,value,on_change){
return (function (p1__12667_SHARP_){
return (this$["cljsInputElement"] = p1__12667_SHARP_);
});})(G__12669,v,value,on_change))
);
...
var vec__12676 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12676,(0),null);
var id = cljs.core.nth.call(null,vec__12676,(1),null);
var class$ = cljs.core.nth.call(null,vec__12676,(2),null);
...
var jsprops = ({"argv": v});
var temp__6757__auto___12681 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__6757__auto___12681 == null)){
} else {
var key_12682 = temp__6757__auto___12681;
(jsprops["key"] = key_12682);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__12684 = (new reagent.impl.template.NativeWrapper());
(G__12684["name"] = c);
...
var len__8605__auto___12690 = arguments.length;
var i__8606__auto___12691 = (0);
while(true){
if((i__8606__auto___12691 < len__8605__auto___12690)){
args__8612__auto__.push((arguments[i__8606__auto___12691]));

var G__12692 = (i__8606__auto___12691 + (1));
i__8606__auto___12691 = G__12692;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq12688){
var G__12689 = cljs.core.first.call(null,seq12688);
var seq12688__$1 = cljs.core.next.call(null,seq12688);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__12689,seq12688__$1);
});
...
break;
default:
var G__12696 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__12696;
continue;
...
var n__8405__auto___12699 = a.length;
var i_12700 = (0);
while(true){
if((i_12700 < n__8405__auto___12699)){
(a[i_12700] = reagent.impl.template.as_element.call(null,(a[i_12700])));

var G__12701 = (i_12700 + (1));
i_12700 = G__12701;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__8405__auto___12702 = a.length;
var i_12703 = (0);
while(true){
if((i_12703 < n__8405__auto___12702)){
var val_12704 = (a[i_12703]);
if((cljs.core.vector_QMARK_.call(null,val_12704)) && ((reagent.impl.template.key_from_vec.call(null,val_12704) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12703] = reagent.impl.template.as_element.call(null,val_12704));
...
var ctx = ({});
var vec__12709 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__12709,(0),null);
var derefed = cljs.core.nth.call(null,vec__12709,(1),null);
...
var G__12713 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12713) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__12713){
