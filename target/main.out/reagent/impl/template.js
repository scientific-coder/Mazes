...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__8041__auto__,writer__8042__auto__,opt__8043__auto__){
return cljs.core._write(writer__8042__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__17870 = o;
(G__17870[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__17871__delegate = function (args){
...
while (G__17872__i < G__17872__a.length) {G__17872__a[G__17872__i] = arguments[G__17872__i + 0]; ++G__17872__i;}
  args = new cljs.core.IndexedSeq(G__17872__a,0);
} 
...
if(cljs.core.truth_((function (){var and__7377__auto__ = cljs.core.some_QMARK_(jsprops);
if(and__7377__auto__){
var and__7377__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__17879 = jsprops;
(G__17879["defaultValue"] = value);

(G__17879["onChange"] = ((function (G__17879,v,value,on_change){
return (function (p1__17876_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__17876_SHARP_);
});})(G__17879,v,value,on_change))
);

(G__17879["ref"] = ((function (G__17879,v,value,on_change){
return (function (p1__17877_SHARP_){
return (this$["cljsInputElement"] = p1__17877_SHARP_);
});})(G__17879,v,value,on_change))
);
...
var vec__17886 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17886,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17886,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17886,(2),null);
...
var jsprops = ({"argv": v});
var temp__6757__auto___17891 = reagent.impl.template.key_from_vec(v);
if((temp__6757__auto___17891 == null)){
} else {
var key_17892 = temp__6757__auto___17891;
(jsprops["key"] = key_17892);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__17894 = (new reagent.impl.template.NativeWrapper());
(G__17894["name"] = c);
...
var G__17896 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__17896) : reagent.impl.template.as_element.call(null,G__17896));
} else {
...
var len__8605__auto___17902 = arguments.length;
var i__8606__auto___17903 = (0);
while(true){
if((i__8606__auto___17903 < len__8605__auto___17902)){
args__8612__auto__.push((arguments[i__8606__auto___17903]));

var G__17904 = (i__8606__auto___17903 + (1));
i__8606__auto___17903 = G__17904;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8613__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq17900){
var G__17901 = cljs.core.first(seq17900);
var seq17900__$1 = cljs.core.next(seq17900);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__17901,seq17900__$1);
});
...
break;
default:
var G__17908 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__17908;
continue;
...
var n__8405__auto___17911 = a.length;
var i_17912 = (0);
while(true){
if((i_17912 < n__8405__auto___17911)){
(a[i_17912] = reagent.impl.template.as_element((a[i_17912])));

var G__17913 = (i_17912 + (1));
i_17912 = G__17913;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8405__auto___17914 = a.length;
var i_17915 = (0);
while(true){
if((i_17915 < n__8405__auto___17914)){
var val_17916 = (a[i_17915]);
if((cljs.core.vector_QMARK_(val_17916)) && ((reagent.impl.template.key_from_vec(val_17916) == null))){
(o["no-key"] = true);
} else {
}

(a[i_17915] = reagent.impl.template.as_element(val_17916));

var G__17917 = (i_17915 + (1));
i_17915 = G__17917;
continue;
} else {
}
...
var ctx = ({});
var vec__17921 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17921,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17921,(1),null);
...
var G__17925 = (cljs.core.count(argv) - first_child);
switch (G__17925) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__17925){
